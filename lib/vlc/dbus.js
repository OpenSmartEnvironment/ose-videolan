...
exports.commands.play = function(req) {  // {{{2
/**
 * Play
 *
 * @method play
...
exports.commands.pause = function(req) {  // {{{2
/**
 * Pause playback
 *
 * @method pause
 ...
 */
  ...
  if (! this.entry.object) {
    return O.link.error(socket, O.error(this.entry, 'Can\'t stop, playback is not connected', req));
  }

  return this.entry.object.Stop(function(err) {
    if (err) {
      O.link.error(socket, err);
    } else {
      O.link.close(socket);
...
exports.commands.turnOff = function(req) {  // {{{2
/**
...
exports.commands.raise = function(req) {   // {{{2
/**
 * Raises window
 *
 * @method raise
...
exports.commands.seek = function(req) {  // {{{2
/**
 * Seek media
 *
...
exports.commands.next = function(req) {  // {{{2
/**
 * Skip to next media
 *
...
exports.commands.previous = function(req) {  // {{{2
/**
