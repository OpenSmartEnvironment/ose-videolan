 ...
 */
  ...
  Tmp.file(function(err, path, fd) {
    ...
    Fs.close(fd, function(err) {
      ...
      var args = [
        '--adapter', entry.dval.adapter || 0,
        '--bandwidth', entry.current.mplex.dval.bandwidth,
        '--frequency', entry.current.mplex.dval.freq,
        '--modulation', entry.current.mplex.dval.modulation,
        '--config-file', path,
        '--epg-passthrough',
      ];
